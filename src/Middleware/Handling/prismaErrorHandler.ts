...
/**
 * Middleware that handles errors generated by prisma ORM.
 *
 * @param err Error 
 * @param _req Request
 * @param res Response
...
export default async function prismaErrorHandler(
  ...
  logger.debug(`treating PrismaClientKnownRequestError with code ${err.code}`);
  switch (err.code) {
    case "P2002":
      return res
        .status(422)
